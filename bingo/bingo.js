...
function BuildBingo(){
  ...
  if (inputs.length < 24){
    inputs = inputs.concat(DefaultList.split(/,/).filter(Boolean))
  }
...
function CopyList(){
  navigator.clipboard.writeText(DefaultList);
}